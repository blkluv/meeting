...
```bash
# MeetONS P2P - HTTPS — proxy all requests to the Node app
server {
	# Enable HTTP/2
...
Check Your MeetONS P2P instance: https://your.domain.name

---

## Update script

In order to have always Your MeetONS P2P updated to latest, we going to create a script
...
Follow the commits of the MeetONS P2P project [here](https://github.com/jaideep25/viMeetONSommits/master)

To update Your MeetONS P2P instance at latest commit, execute:
...
[![](https://www.buymeacoffee.com/assets/img/custom_images/orange_img.png)](https://www.buymeacoffee.com/MeetONS/viMeetONSreen-sharing)
