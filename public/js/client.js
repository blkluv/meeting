...
/**
 * MeetONS - Client component
 *
 * @link    GitHub: https://github.com/
 * @link    Official Live demo: https://MeetONS.up.railway.app
...
let recStartTime;
let recElapsedTime;
let MeetONSTheme = "neon"; // neon - dark - forest - ghost ...
...
function getHtmlElementsById() {
  ...
  themeSelect = getId("MeetONSTheme");
      ...
      switch (event.channel.label) {
        case "MeetONS_chat_channel":
          try {
            ...
            console.error("MeetONS_chat_channel", err);
          }
          break;
        case "MeetONS_file_sharing_channel":
          try {
            let dataFile = msg.data;
            handleDataChannelFileSharing(dataFile);
          } catch (err) {
            console.error("MeetONS_file_sharing_channel", err);
          }
          break;
      }
    };
...
function setMyWhiteboardBtn() {
  ...
  whiteboardGhostButton.addEventListener("click", (e) => {
    ...
    //wbIsBgTransparent ? wbCanvasBackgroundColor('rgba(0, 0, 0, 0.100)'): setTheme(MeetONSTheme);
  });
}
...
function shareRoomMeetingURL(checkScreen = false) {
  ...
  Swal.fire({
    ...
    html: `
        ...
        <p style="background:transparent; color:white;">Invite someone else to join by sending them this URL</p>
    ...
    if (result.isConfirmed) {
      ...
      let message = {
        email: "",
        subject: "Please join our Conference using MeetONS.",
...
function showAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>MeetONS Made with ❤️</strong>",
    imageAlt: "About",
    imageUrl: aboutImg,
    html: `
        <br/>
        <div id="about">
            ...
            <a href="https://github.com/" target="_blank"><br/></br>
